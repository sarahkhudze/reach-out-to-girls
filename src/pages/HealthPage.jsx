    ...
    >
      ...
      <div className="max-w-5xl mx-auto space-y-10 text-gray-700">
        ...
        <div className="bg-[#f8fbfd] border-l-4 border-[#65a7b2] p-6 rounded-r-lg">
          ...
          <p className="mb-4">
            We have launched a transformative project known as{" "}
            <strong>`Smart Period`</strong> to advance menstrual health and
            hygiene management among adolescent girls, particularly in secondary
            schools across rural Malawi.
          </p>
          <p>
            With a primary focus on Community Day Secondary Schools (CDSSs), our
        ...
        <div>
          ...
          <p className="leading-relaxed mb-4">
            In many rural communities, lack of access to menstrual products and
            education leads to school absenteeism, shame, and health risks. By
            normalizing conversations and providing practical solutions, we keep
            girls in school and empower them with dignity.
          </p>
          <p className="leading-relaxed">
            The Smart Period initiative doesn’t just provide pads — it builds
        ...
        <div className="bg-[#f0f9ff] border-l-4 border-[#FFBE0B] p-6 rounded-r-lg">
          ...
          <p>
            Every girl deserves to manage her period with dignity, safety, and
            confidence. Your support helps us distribute more kits, train more
