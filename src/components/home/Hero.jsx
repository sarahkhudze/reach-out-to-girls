    ...
    <div id="section-1" className="w-full">
      <div className="max-w-screen-xl mx-auto text-center items-center justify-center">
        <div className="text-center text-black">
          <p className="text-xl md:text-3xl mt-12 md:mt-24  font-bold">
            OUR SERVICES
          </p>
        ...
        <div className="max-w-screen-xl mx-auto py-10 md:py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[2%] md:gap-[2%]  pl-12 md:pl-12 pr-12 md:pr-12">
          ...
          >
            ...
            <p className="text-sm md:text-md md:mt-8 mb-12 md:mb-0 hover:text-[#000000]">
              Our solutions are all about simpl Our solutions are all about
              simplificationification
            </p>
          </div>
          <div
            id="div2"
          ...
          >
            {/* <AiFillEyeInvisible className="w-full h-16" /> */}
            <img src={enrollment_services} className="w-20" />
            <p className="text-sm md:text-md md:mt-8 mb-12 md:mb-0 font-bold">
              ENROLMENT SERVICES
            </p>
            <p className="text-sm md:text-md md:mt-8 mb-12 md:mb-0 hover:text-[#000000]">
          ...
          >
            {/* <AiFillEyeInvisible className="w-full  h-16" /> */}
            <img src={identity_solution} className="w-20" />
            <p className="text-sm md:text-md md:mt-8 mb-12 md:mb-0 font-bold">
              IDENTITY SOLUTIONS
            </p>
            <p className="text-sm md:text-md md:mt-8 mb-12 md:mb-0 hover:text-[#000000]">
