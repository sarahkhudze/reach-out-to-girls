  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-600 max-w-2xl mb-12">
        The driving force behind Solutions Inc — blending innovation, community,
          ...
          >
            {loading ? (
              ...
              <div className="relative mb-6">
                ...
                <div className="absolute -inset-2 rounded-full border-2 border-[#E8B504]/30 pointer-events-none"></div>
              </div>
            )}
            ...
            {loading ? (
              ...
              <>
                <h3 className="text-2xl font-bold text-[#096E6A] mb-3">
                  {founder.title}
                </h3>
