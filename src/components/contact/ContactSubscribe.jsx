...
const ContactSubscribe = () => {
  return (
    ...
    <p className="hidden md:block opacity-75 md:my-3">
        An Avenue to harness your skills and stand out
    </p>
    <Link to="/career-page">
        <span className="cursor-pointer text-[#003997] underline">
            Click here to proceed to career page
        </span>
    </Link>
</div>
