  ...
  return (
    <div className="w-full bg-[#C8E0EB] pt-[4%] pb-[4%]">
      ...
      <p className="max-w-screen-xl mx-auto ">
        ...
        <p className="font-bold text-md">1) To protect (Confidentiality)</p>
        To protect information assets against unauthorized disclosure.
        <p className="font-bold text-md">2) To maintain (Integrity)</p>
        To protect information assets from unauthorized or accidental modification ensuring the accuracy and completeness of the organization’s assets.
        <p className="font-bold text-md">3) To ensure (Availability)</p> <br /> <br />
